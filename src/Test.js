                ...
                questions: [
                    {
                        ...
                        answer:  'margin and padding '
                    },{
                        no:  'Question 3: ',
                        text:  'The CSS margin properties are used to generate: ',
                        options: {
                            a: 'space around elements ', b: 'space between elements ', c: 'border around elements ', d: 'none of these '
                        },
                        answer:  'space around elements '
                    },{
                        no:  'Question 4: ',
                        text:  'The CSS padding properties are used to generate: ',
                        options: {
                            a: 'space around elements ', b: 'space between elements ', c: 'border around elements ', d: 'none of these '
                        },
                        answer:  'space between elements '
                    },{
                        no:  'Question 5: ',
                        text:  'Available units for margin and padding? ',
                        options: {
                            a: 'px ', b: '% ', c: 'em ', d: 'all of these '
                        },
                        answer:  'all of these '
                    }, {
                        no:  'Question 6: ',
                        text:  'Which property used to change the font color? ',
                        options: {
                            a:  'font-color ', b:  'color-font ', c:  'font-forecolor ', d:  'color '
                        },
                        answer:  'color '
                    },{
                        no:  'Question 7: ',
                        text:  'Which property used to change the background color? ',
                        options: {
                            a: 'background ', b: 'background-color ', c: 'back-color ', d: 'both a & b '
                        },
                        answer:  'both a & b '
                    },{
                        no:  'Question 8: ',
                        text:  'What is the correct sequence for applying margin and padding? ',
                        options: {
                            a:  'top, right, bottom, left ', b:  'left, top, right, bottom ', c:  'left, bottom, right, top ', d:  'none of these '
                        },
                        answer:  'top, right, bottom, left '
                    },{
                        no:  'Question 9: ',
                        text:  'What is correct Shorthand property for Border ',
                        options: {
                            a:  'border: width, color, type ', b:  'border: type, color, width ', c:  'border: width, type, color ', d:  'none of these '
                        },
                        answer:  'border: width, type, color '

                    },{
                        no:  'Question 10: ',
                        text:  'How to remove default styling of ordered/unordered list? ',
                        options: {
                            a:  'list-style: default ', b:  'list-style: none ', c:  'list-style: no-style ', d:  'list-style: no-bullets '
                        },
